...
public class THORRedRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        autoMethods = new AutoMethods(motorLeft, motorLeft2, motorRight, motorRight2, motorIntake, motorHang, telemetry, ledDriver, -4);
